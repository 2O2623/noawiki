...
<summary style="padding: 6px; font-size: 0.8em; cursor: pointer; color: #fff; text-align: center; list-style: none;">기타 언어 버전 ▼</summary>
<div style="display: flex; justify-content: space-around; padding: 10px; font-size: 0.8em; border-top: 1px dashed #ccc;">
<a href="#" style="color: #fff; text-decoration: none;">[ 일본어 ]</a>
<a href="#" style="color: #fff; text-decoration: none;">[ 중국어 ]</a>
<a href="#" style="color: #fff; text-decoration: none;">[ 영어 ]</a>
</div>
</details>
</div>
<div style="width: 100%; max-width: 600px; margin: 0 auto 30px auto; border: 1px solid #a8a8a8; background: #fff;">
